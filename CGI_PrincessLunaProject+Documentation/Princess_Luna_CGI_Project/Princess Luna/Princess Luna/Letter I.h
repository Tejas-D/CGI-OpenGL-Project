...
/***********************/
						...
						//These parameters change the position and size of the  I
void Letters::letter_i(float translateX, float translateY, float translateZ,float rotateAngle, float rotateX, float rotateY, float rotateZ ,float scaleX, float scaleY, float scaleZ)
{
